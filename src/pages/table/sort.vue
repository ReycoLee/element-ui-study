  ...
  <div class="panel">
    <panel-title :title="$route.meta.title">
      <div class="inline-query">
        <el-input size="small" placeholder="姓名/编号" suffix-icon="el-icon-date" v-model="params.query">
        </el-input>
      </div>
      <el-button @click.stop="on_refresh" icon="search" size="small">查询</el-button>
      <router-link :to="{name: 'tableAdd'}" tag="span">
        <el-button type="success" icon="plus" size="small">添加用户</el-button>
      </router-link>
    </panel-title>
    <div class="panel-body">
      <el-table :data="table_data" v-loading="load_data" element-loading-text="正在加载中" @selection-change="on_batch_select" style="width: 100%;">
        ...
        <el-table-column prop="zip" label="邮编" width="120" sortable>
        </el-table-column>
