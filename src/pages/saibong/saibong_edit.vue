        ...
        <el-col :offset="6" :span="8">
          <el-form ref="form" :model="form" :rules="rules" label-width="150px">
            <el-form-item label="采番KEY" prop="cfzdm">
              <el-input v-model="form.cfzdm" placeholder="请输入采番KEY" :disabled="true" style="width: 250px;"></el-input>
            </el-form-item>
  ...
  methods: {
    ...
    getFormData() {
      ...
      this.$fetch.api_saibong
        ...
        .then(({ data }) => {
          this.form = {
            cfzdm: data.saibongRules.cfzdm,
            twz: data.saibongRules.twz,
            lscd: data.saibongRules.lscd.toString(),
            fgf: data.saibongRules.fgf,
            sx1: data.saibongRules.sx1,
            sx2: data.saibongRules.sx2,
            sx3: data.saibongRules.sx3,
            isb0: data.saibongRules.isb0.toString(),
            cfsm:data.saibongRules.cfsm,
            dqlsh:data.saibongRules.dqlsh
          }
